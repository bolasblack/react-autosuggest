      ...
      var s =
        ...
        S = (function(e) {
          function t(e) {
            ...
            return b.call(o), (o.state = {
              isFocused: !1,
              isCollapsed: !n,
              highlightedSectionIndex: null,
              highlightedSuggestionIndex: null,
              valueBeforeUpDown: null
            }), (o.justPressedUpDown = !1), o;
          }
          return u(t, e), a(t, [
            {
            ...
            },
            {
              ...
              value: function(e) {
                (0, d.default)(e.suggestions, this.props.suggestions)
              ...
              value: function(e, t, n) {
                this.setState(function(o) {
                  ...
                  return null === t
                    ...
                    : null === i &&
                        'undefined' != typeof n &&
                        (i = n), { highlightedSectionIndex: e, highlightedSuggestionIndex: t, valueBeforeUpDown: i };
                });
              }
            },
            {
            ...
            },
            {
              ...
              value: function() {
                var e = this,
                  ...
                  S = I.isFocused,
                  b = I.isCollapsed,
                  w = I.highlightedSectionIndex,
                  x = I.highlightedSuggestionIndex,
                  _ = I.valueBeforeUpDown,
                  O = y ? v : this.props.shouldRenderSuggestions,
                  C = u.value,
                  j = u.onFocus,
                  P = u.onKeyDown,
                  ...
                  D = s({}, u, {
                    onFocus: function(t) {
                      if (
                        ...
                        var n = O(C);
                        e.setState({ isFocused: !0, isCollapsed: !n }), j &&
                          j(t), n && i({ value: C, reason: 'input-focused' });
                      }
                    },
                    onBlur: function(t) {
                      ...
                      switch (t.key) {
                        ...
                        case 'ArrowUp':
                          if (b)
                            O(C) &&
                              (
                                i({ value: C, reason: 'suggestions-revealed' }),
                                e.revealSuggestions()
                              );
                          else if (n.length > 0) {
                            var r = o.newHighlightedSectionIndex,
                              u = o.newHighlightedItemIndex,
                              s = void 0;
                            (s = null === u
                              ? null === _ ? C : _
                        ...
                        case 'Enter':
                          ...
                          if ((R && !y && e.closeSuggestions(), null !== a)) {
                            var l = h(a);
                            e.maybeCallOnChange(
                              t,
                              l,
                        ...
                        case 'Escape':
                          ...
                          if (null === _) {
                            if (!c) {
                              var g = '';
                              e.maybeCallOnChange(t, g, 'escape'), O(g)
                                ? i({ value: g, reason: 'escape-pressed' })
                                : e.onSuggestionsClearRequested();
                            }
                          } else e.maybeCallOnChange(t, _, 'escape');
                          c
                            ? (
                                e.onSuggestionsClearRequested(),
                                e.closeSuggestions()
                      ...
                      P &&
                        P(t, {
                          isAnySuggestionFocused:
                            null != e.state.highlightedSuggestionIndex
                        });
                    }
                  }),
        ...
        C = (function(e) {
          function t(e) {
            ...
            return (n.storeInputReference = function(e) {
              ...
              isInputFocused: !1
            }), n.setSectionsItems(e), n.setSectionIterator(e), n.setTheme(
              e
            ), n;
          }
          return u(t, e), l(t, [
                ...
                if (e) {
                  ...
                  n < o
                    ...
                    : n + e.offsetHeight > o + t.offsetHeight &&
                        (o = n + e.offsetHeight - t.offsetHeight), o !==
    ...
    function(e, t) {
      ...
      function o(e) {
        ...
        return Object.getOwnPropertySymbols &&
          (t = t.concat(Object.getOwnPropertySymbols(e))), t.filter(function(
          t
        ) {
          return i.call(e, t);
        });
                ...
                return c.default.createElement(
                  ...
                  n.map(function(t, n) {
                    var f = 0 === n,
                      ...
                      I = s(
                        { id: l(u, n) },
                        g(v, 'item', f && 'itemFirst', m && 'itemHighlighted'),
                        y
                      );
                    return m &&
                      (I.ref =
                        e.storeHighlightedItemReference), c.default.createElement(h.default, s({}, I, { sectionIndex: u, isHighlighted: m, itemIndex: n, item: t, renderItem: i, renderItemData: r }));
                  })
                );
              }
            }
          ...
          return s(t, e), l(t, [
            ...
            },
            {
              ...
              value: function() {
                ...
                return delete u.sectionIndex, delete u.itemIndex, 'function' ==
                  typeof u.onMouseEnter &&
                  (u.onMouseEnter = this.onMouseEnter), 'function' ==
                  typeof u.onMouseLeave &&
                  (u.onMouseLeave = this.onMouseLeave), 'function' ==
                  typeof u.onMouseDown &&
                  (u.onMouseDown = this.onMouseDown), 'function' ==
                  typeof u.onClick &&
                  (u.onClick = this.onClick), g.default.createElement(
                  'li',
                  a({ role: 'option' }, u, { ref: this.storeItemReference }),
